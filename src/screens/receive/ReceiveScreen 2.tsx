...
export const ReceiveScreen: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Gradient orbs */}
      <motion.div 
        className="fixed top-20 right-0 w-64 h-64 rounded-full blur-3xl pointer-events-none z-0"
      ...
      {/* Centered Container */}
      <div className="max-w-2xl mx-auto flex flex-col min-h-screen relative z-10">
